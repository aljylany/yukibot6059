...
- **أمر إيقاف/تفعيل التحليل**: متاح لمالكي المجموعات والرتب العليا
- **الأوامر المقترحة**:
  ```
  /disable_user_analysis - إيقاف تحليل المستخدمين في المجموعة
  /enable_user_analysis - تفعيل تحليل المستخدمين في المجموعة
  /analysis_status - عرض حالة التحليل في المجموعة
  ```
- **الصلاحيات المطلوبة**: مالك المجموعة، المالك الأساسي، المنشئ، أو رتب أعلى
...
- **أوامر التحكم للمالكين والإدارة العليا**:
  ```
  /disable_user_analysis أو تعطيل تحليل الأعضاء
  /enable_user_analysis أو تفعيل تحليل الأعضاء  
  /analysis_status أو حالة التحليل
  /analysis_settings أو إعدادات التحليل
  ```

#### **2. مستويات التحكم**
- **المالك الأساسي**: تحكم كامل في جميع إعدادات التحليل
- **مالك المجموعة**: إيقاف/تفعيل التحليل + عرض الإعدادات
