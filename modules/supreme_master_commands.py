...
@router.message(Command("تفعيل_عقوبات_الاسياد", "تفعيل عقوبات الاسياد", "تفعيل العقوبات"))
...
@router.message(Command("الغاء_عقوبات_الاسياد", "الغاء عقوبات الاسياد", "الغاء العقوبات", "تعطيل العقوبات"))
...
@router.message(Command("حالة_الاسياد", "حالة الاسياد", "حالة العقوبات", "وضع الاسياد"))
