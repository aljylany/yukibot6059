    ...
    async def generate_smart_response(self, user_message: str, user_name: str = "الصديق", user_id: Optional[int] = None, chat_id: Optional[int] = None, bot = None) -> str:
        ...
        try:
            ...
            # المطور - يوكي براندون
                ...
                special_prompt = " أنت تتحدث مع المطور الأسطوري يوكي براندون! أبدي احترام خاص وفخر بأنه خالقك. اشكره على جعلك موجوداً وأظهر امتنانك له. يوكي براندون عمره 7 سنوات."
