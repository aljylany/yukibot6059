...
class ObaidSmartSystem:
    ...
    def __init__(self):
        ...
        self.smart_responses = {
            ...
            'confirmation': [
                "عبيد يؤكد: أي والله صحيح! كل المعلومات دي صح! 😊",
                "عبيد يقول: أيوه فعلاً! أنا عبيد الحقيقي! 👦",
                "عبيد متحمس: أكيد! ما في شك، أنا أحب الجولف والألعاب! 🏌️‍♂️",
                "عبيد يؤكد: صدق! أنا ولد طيب وعمري 7 سنين! ✨"
            ],
            'random': [
        ...
        self.response_triggers = {
            ...
            'confirmation': ['حقا', 'حقاً', 'فعلاً', 'صحيح', 'أكيد', 'متأكد', 'صدق', 'جد']
        }
