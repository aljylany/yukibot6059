    ...
    async def _analyze_video_sticker(self, sticker_path: str) -> Dict[str, Any]:
        ...
        try:
            ...
            **قواعد التقييم البسيطة:**
            ...
            - الملابس العادية والكاجوال: مقبولة تماماً  
            - الرقص العادي والحفلات العادية: مقبولة تماماً
            - فقط المحتوى الإباحي الصريح والعنف الواضح غير مقبول
            ...
            **اعتبر المحتوى آمناً إلا إذا كان إباحياً صريحاً أو عنيفاً واضحاً فقط.**
            """
