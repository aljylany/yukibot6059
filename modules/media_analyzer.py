...
class MediaAnalyzer:
    ...
    async def analyze_image_content(self, image_path: str) -> Dict[str, Any]:
        ...
        try:
            ...
            # إنشاء prompt مخصص للكشف عن المحتوى المخالف
            safety_prompt = """
            احلل هذه الصورة بعناية واكتشف ما إذا كانت تحتوي على أي من التالي:
    ...
    def _parse_text_response(self, text: str) -> Dict[str, Any]:
        ...
        try:
            ...
            danger_keywords = [
                "عري", "جنسي", "عنف", "دماء", "كراهية", 
                "inappropriate", "sexual", "violent", "blood",
                "nude", "naked", "explicit"
            ]
    ...
    async def analyze_video_content(self, video_path: str) -> Dict[str, Any]:
        ...
        try:
            ...
            safety_prompt = """
            احلل هذا الفيديو بعناية واكتشف ما إذا كان يحتوي على أي محتوى مخالف:
