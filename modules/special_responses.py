...
GENERAL_RESPONSES = {
    ...
    "bot_insult": [
        "هيه! أنا فخور إني بوت ذكي 🤖💪",
        "أجل أنا بوت، لكن بوت مفيد! 😎",
        "بوت وافتخر! على الأقل ما أزعل 😂",
        "صحيح أنا بوت، بس بوت طيب 🤖❤️",
        "ههههه، أنا بوت بس أذكى من كثيرين 🧠✨",
        "أنا بوت، وإنت إنسان، كلنا نخدم بعض 🤝"
    ]
}
