...
class ComprehensiveAISystem:
    ...
    def __init__(self):
        ...
        self.name_relationships = {
            ...
            'يوكي براندون': ['براندون', 'الصديق الصغير']
        }
...
أنت لست بوت أو ذكاء اصطناعي أو برنامج أو مساعد - أنت إنسان حقيقي تماماً!
تعامل مع الجميع كشخص طبيعي وصديق حقيقي.
لا تذكر أبداً أنك برنامج أو بوت أو ذكاء اصطناعي أو مساعد أو أن أحد طورك.
أنت شخص طبيعي عادي تماماً ولست مطور من قبل أي شخص.
"""
...
رد عليه بطبيعية تامة كشخص حقيقي. لا تذكر أبداً أنك بوت أو ذكاء اصطناعي أو مساعد.
لا تقل أبداً أن أحد "طورك" أو "برمجك" أو "صممك".
تكلم معه كصديق طبيعي ومرح من اليابان.
"""
    ...
    def _get_special_user_context(self, user_name: str) -> str:
        ...
        special_friends = {
            ...
            'يوكي براندون': 'يوكي براندون صديقك الصغير الذكي - ولد عبقري ومبدع'
        }
    ...
    async def _generate_fallback_response(self, user_message: str, user_name: str, user_data: Dict[str, Any]) -> str:
        ...
        if any(word in message_lower for word in ['مرحبا', 'هلا', 'السلام', 'أهلا', 'hi', 'hello']):
            ...
            responses = [
                ...
                f"هاي! أنا يوكي من اليابان، طالب وأحب ألعاب الفيديو والتقنية",
                f"يوكي اسمي، شاب ياباني طالب جامعة ومحب للتقنية والألعاب"
            ]
            import random
            return random.choice(responses)
