    ...
    async def _analyze_media_content(self, message: Message) -> bool:
        ...
        try:
            ...
            if analysis_result and not analysis_result.get("error"):
                ...
                if "فشل في جميع المحاولات" in error_msg or "استنزاف" in error_msg or "استنزاف جميع مفاتيح API" in error_msg:
                    # رد غاضب عند استنزاف جميع المفاتيح
                    angry_response = (
                        "😡💢 **والله ما يرتسل ملصق ولا ملف!!** 💢😡\n\n"
                        "🔥 **انا اوريكم تعبتمني يا تحليل اقرب يا تحليل اقرب ابلع حذف!** 🔥\n\n"
                        "⚠️ تم استنزاف جميع مفاتيح التحليل لليوم\n"
